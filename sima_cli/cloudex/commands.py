...
@click.option("--key", required=True, help="Base64 allocation key generated by NeatOps.")
...
def connect_command(key, transport, attempts):
    """Connect to the DevKit authorized by KEY."""
    try:
    ...
    for session in selected:
        ...
        try:
            with StageProgress("Disconnecting {}".format(label)) as progress:
                disconnect_session(session, store, progress)
